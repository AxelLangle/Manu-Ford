                            ...
                            <div style={{ marginTop: 12 }}>
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            fill="#EA4335"
                                            d="M23 9.5c3.54 0 6.72 1.27 9.23 3.36l6.9-6.9C35.1 2.6 29.4 0 23 0 14.7 0 7.36 4.75 3.68 11.6l7.99 6.2C13.9 12.1 17.96 9.5 23 9.5z"
                                        />
                                        <path
                                            fill="#34A853"
                                            d="M45.5 23c0-1.64-.16-3.22-.45-4.73H23v9.02h12.34c-.53 2.88-2.28 5.13-4.86 6.69l7.45 5.78C43.5 35.1 45.5 29.5 45.5 23z"
                                        />
                                        <path
                                            fill="#4A90E2"
                                            d="M11.67 28.8A13.99 13.99 0 0 1 11.67 17.2L3.68 11.6A23 23 0 0 0 0 23c0 3.56.86 6.92 2.39 9.86l9.28-4.06z"
                                        />
                                        <path
                                            fill="#FBBC05"
                                            d="M23 46c6.4 0 12.1-2.1 16.54-5.7l-7.45-5.78C29.98 34.4 26.7 35.5 23 35.5c-5.08 0-9.3-3.01-11-7.2l-9.28 4.06C7.36 41.25 14.7 46 23 46z"
                                        />
                                    </svg>
